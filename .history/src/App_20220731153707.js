...
function App() {
  return (
    <div className="App">
      ...
      <motion.div viewport={{once: true}} transition={{ duration: 1}} whileInView={{ y: ["-2000px", "0px", "-50px", "-25px"],}}></motion.div>
              ...
              <div className="about-me-left">
                <div className="details-content">
                  ...
                  <img
                    ...
                    alt="Profile Photo"
                  />
                  <motion.div viewport={{once: true}} transition={{ duration: 1}} whileInView={{ y: ["-2000px", "0px", "-50px", "-25px"],}}>                  <p>Conjoint Engineering (honours) & Commerce at UoA</p>
