        ...
        <div>
          ...
          <Grid container spacing={2}>
            {ProjectsData.map((Project, i) => (
              <Grid item xs={6} md={4}>
              <div className="project-box"><img src={Project.header} className="project-header-image" alt={Project.title}/>
                <h3>{Project.title}</h3>
                <h4>{Project.affiliation}</h4>
                <div className="project-bottom-bar" style={{backgroundColor: Project.color}}></div></div>
